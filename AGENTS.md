...
## Obsidian + Codex — Memory Strategy

Load context on demand using `@file` references in the Codex prompt — do not auto-inject daily notes or entire vault content into every session.
